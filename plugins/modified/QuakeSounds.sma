...
#define STREAK_X_POSITION (0.05)
#define STREAK_Y_POSITION (0.65)
...
// PLUGIN'S VERSION
//
#define QS_PLUGIN_VERSION				( "5.1" )			// "5"
...
__Display ( Killer, Message [ ], Sound [ ] )
{
	...
	set_hudmessage ( g_Red, g_Green, g_Blue, STREAK_X_POSITION, STREAK_Y_POSITION, _, _, QS_HUD_MESSAGE_HOLD_TIME );
